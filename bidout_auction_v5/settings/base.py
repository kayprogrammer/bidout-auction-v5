...
ROOT_URLCONF = "bidout_auction_v5.urls"
...
WSGI_APPLICATION = "bidout_auction_v5.wsgi.application"
...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "BIDOUT AUCTION V5 ADMIN",
    ...
    "welcome_sign": "Welcome to the Bidout Auction v5 Admin Section",
    # Copyright on the footer
    "copyright": "Bidout Auction v5 Ltd",
    ...
    "usermenu_links": [
        {"name": "BA V5 FrontPage", "url": FRONTEND_URL, "new_window": True},
        {"model": "accounts.user"},
    ],
    #############
    # Side Menu #
